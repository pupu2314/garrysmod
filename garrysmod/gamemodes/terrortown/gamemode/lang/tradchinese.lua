...
local L = LANG.CreateLanguage("中國")
...
L.round_minplayers = "沒有足夠的玩家開始新的回合… "
L.round_voting     = "投票進行中，新的回合延遲至 {num} 秒後 "
...
L.limit_round      = "已達遊戲回合上限，接著將讀取進入 {mapname}  "
L.limit_time       = "已達遊戲時間上限，接著將讀取進入 {mapname}  "
L.limit_vote       = "遊戲回合或時間已達上限。投票時間來囉！ "
L.limit_left       = "在地圖讀取進入 {mapname} 前，還有 {num} 回合或者 {time} 分鐘的剩餘時間。 "

--- Credit awards
L.credit_det_all   = "探長，依據你的表現，將獲得 {num} 點購買餘額。 "
L.credit_tr_all    = "叛徒，依據你的表現，將獲得 {num} 點購買餘額。 "

L.credit_kill      = "你殺死 {role} 而獲得了 {num} 點購買餘額 "

--- Karma
L.karma_dmg_full   = "你的業值為 {amount} ，此回合你擁有造成百分之百傷害的待遇！ "
...
L.body_call_error  = "你必須確認該玩家的死，才能呼喚探長！ "

L.body_burning     = "噢！這屍體著火了！ "
L.body_credits     = "你在屍體上找到 {num} 點購買餘額！ "
...
L.xfer_no_credits = "你沒有傳送餘額了 "
L.xfer_send       = "發送傳送餘額 "
L.xfer_help       = "你只能轉移傳送餘額給 {role} 玩家。 "
...
L.search_role_t = "這人是叛徒！ "
L.search_role_d = "這人是探長。 "
L.search_role_i = "這人是無辜的恐怖分子。 "
...
L.search_eyes   = "通過你的探查技能，你確信他臨死前見到的最後一個人： {player} 。是兇手，還是巧合？ "
...
L.set_lowsights_tip = "開啟瞄準器時隱蔽武器模組，這會讓你更容易看見目標，但會減少遊戲真實程度。 "
L.set_fastsw        = "快速切換武器 "
L.set_fastsw_tip    = "允許你直接用滑鼠滾輪切換武器（註：將不開啟武器選單，直接取出）。 "
...
L.set_specmode_tip  = "在你離開本模式前，新回合開始時你仍會以旁觀者加入遊戲。 "
L.set_mute          = "死亡後不再聽到活人的語音（僅作用於你） "
L.set_mute_tip      = "當你是死者／旁觀者時，將聽不見活人的語音。 "
...
L.buy_no_stock    = "無法購買此武器：你已擁有它了。 "
L.buy_pending     = "你已訂購此物品，請等待配送。 "
...
L.c4_no_disarm    = "在其他叛徒死前，你無法拆除他的C4。 "
...
L.c4_disarm_t     = "剪斷引線以拆除C4。你是叛徒，當然每條引線都是安全的，但其他人可就沒那麼容易了！ "
L.c4_disarm_owned = "剪斷引線以拆除C4。你是裝置此C4的人，細節了然於胸，任一條引線都可成功拆除。 "
...
L.dna_menu_help1  = "這些是你採集的DNA樣本 "
L.dna_menu_help2  = [[
充電完畢後，你可以選取之DNA樣本，掃描其主人之準確位置。
找尋遠距離的目標將消耗更多能量。]]
...
L.target_credits = "搜索屍體以獲取未被消耗的購買餘額 "

-- Traitor buttons (HUD buttons with hand icons that only traitors can see)
L.tbut_single  = "單獨使用 "
L.tbut_reuse   = "重覆使用 "
L.tbut_retime  = "在 {num} 秒後重覆使用 "
L.tbut_help    = "按下 {key} 鍵啟動 "

-- Equipment info lines (on the left above the health/ammo panel)
L.disg_hud     = "開始偽裝，你的名字已隱藏。 "
...
用它們來確保無辜者的生命，但請小心：叛徒將優先殺害你！
按下 {menukey} 取得裝備！]]


L.info_popup_traitor_alone = [[你是位叛徒！這回合中你沒有同伴！
...
L.idle_popup = [[你閒置了 {num} 秒，所以被轉往觀察者模式。
當你位於此模式時，將不會在回合開始時重生。
...
L.tip5 = "叛徒殺死探長時，會立即得到一點購買餘額。 "

L.tip6 = "一名叛徒死後，所以探長將得到一點購買餘額作為獎勵。 "

L.tip7 = "叛徒殺害無辜者，有了絕好進展時，所有叛徒將獲得一點購買餘額作為獎勵。 "

L.tip8 = "叛徒和探長能從夥伴屍體上，取得未被消耗的購買餘額。 "

L.tip9 = "搗蛋鬼將使物體變得極其危險。搗蛋鬼調整過的物體將產生爆炸能量傷害接近它的人。 "

L.tip10 = "叛徒與探長應保持注意螢幕右上方的紅色訊息，這對你無比重要。 "

L.tip11 = "若叛徒與探長能和同伴配合得好，將擁有額外的購買餘額。請將它用在對的地方！ "
...
L.tip19 = "探長若有多餘的購買餘額，可將拆彈器交給一位可信任的無辜者，將危險的C4交給他們，自己全神貫注地調查與處決叛徒。 "
...
L.tip25 = "探長確認屍體後，相關訊息將在計分板公佈，如要查看只需點擊死者之名字即可。. "

L.tip26 = "計分板上，人物名字旁的放大鏡圖樣可以查看關於他的信息，若圖樣亮著，代表是某位探長確認後的結果。 "

L.tip27 = "探長調查屍體後的結果將公佈在計分板，供所有玩家查看。 "
...
L.ev_credit      = "{finder} 在 {player} 的屍體上找到 {num} 點購買餘額 "

L.ev_start       = "遊戲開始 "
L.ev_win_traitor = "叛徒成功完成了陰謀 "
L.ev_win_inno    = "無辜者成功在這場危機中倖存 "
L.ev_win_time    = "叛徒因超時而無法實現陰謀 "

--- Awards/highlights

L.aw_sui1_title = "自殺教團的團長 "
L.aw_sui1_text  = "向其他自殺者展示如何自殺並率先實踐。 "
...
L.aw_exp2_text  = "在自家研究C4，威力完全不夠。 "

L.aw_fst1_title = "第一滴血 "
L.aw_fst1_text  = "將第一位無辜者的生命送到伙伴手邊。 "

L.aw_fst2_title = "就愛黑色幽默 "
L.aw_fst2_text  = "擊殺一名叛徒同伴而得到第一殺，幹得好啊！ "
...
L.aw_fal2_title = "地板人 "
L.aw_fal2_text  = "使他的身體從極端無盡的高度上落地，打入地板成為地板人。 "
...
L.aw_sgn1_text  = "用霰彈槍近距離殺了 {num} 名玩家。 "
...
L.set_avoid_det_tip = "開啟這個選項告訴服務器「不要把人家選成探長嘛！」。這不代表你有更高幾率被選為叛徒。 "
